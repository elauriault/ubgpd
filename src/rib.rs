...
impl Default for RouteAttributes {
    fn default() -> Self {
        RouteAttributes {
            ...
            peer_rid: 0,
            peer_ip: IpAddr::V4(Ipv4Addr::new(0, 0, 0, 0)),
        }
    }
}
...
impl RouteAttributes {
    ...
    pub async fn new(
        ...
        let peer_ip;
        {
            ...
            remote_asn = nb
                .remote_asn
                .expect("BUG: Remote ASN should be set after BGP session establishment");
            peer_rid = nb
                .remote_rid
                .expect("BUG: Remote RID should be set after BGP session establishment");
            peer_ip = nb
                .remote_ip
                .expect("BUG: Remote IP should be set after BGP session establishment");
        }
        ...
        // This is not the right way to determine path_type. We should only set to internal if the
        // route is locally generated by the router
